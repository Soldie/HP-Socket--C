...
{ /*
  ...
  *			FALSE	-- 失败
  */ }
function HP_Server_Send(pServer: Pointer; dwConnID: DWORD;
...
{ /*
  ...
  *			FALSE	-- 失败
  */ }
function HP_Server_Disconnect(pServer: Pointer; dwConnID: DWORD; bForce: DWORD)
  : Boolean; stdcall; external HPSocketDLL;
