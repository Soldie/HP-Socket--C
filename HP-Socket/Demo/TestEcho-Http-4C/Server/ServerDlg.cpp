	...
	: CDialogEx(CServerDlg::IDD, pParent)
{
	...
	// 初始化 SSL 全局环境参数
	::HP_SSL_Initialize(SSL_SM_SERVER, SSL_VM_NONE, g_s_lpszPemCertFile, g_s_lpszPemKeyFile, g_s_lpszKeyPasswod, g_s_lpszCAPemCertFileOrPath, SIN_ServerNameCallback);
	VERIFY(::HP_SSL_IsValid());

	SPECIAL_SERVER_INDEX = ::HP_SSL_AddServerContext(SSL_VM_NONE, g_s_lpszPemCertFile2, g_s_lpszPemKeyFile2, g_s_lpszKeyPasswod2, g_s_lpszCAPemCertFileOrPath2);
