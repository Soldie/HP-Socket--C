...
namespace HPSocketCS
{
    public class TcpServer
    {
        ...
        public virtual void SetCallback(HPSocketSdk.OnPrepareListen prepareListen, HPSocketSdk.OnAccept accept, HPSocketSdk.OnSend send, HPSocketSdk.OnReceive recv, HPSocketSdk.OnClose close, HPSocketSdk.OnError error, HPSocketSdk.OnShutdown shutdown)
        {
            ...
            // 设置 Socket 监听器回调函数
            SetOnPrepareListenCallback(prepareListen);
            SetOnAcceptCallback(accept);
        ...
        {
            OnPrepareListenCallback = prepareListen == null ? null : new HPSocketSdk.OnPrepareListen(prepareListen);
        ...
        {
            OnAcceptCallback = accept == null ? null : new HPSocketSdk.OnAccept(accept);
         ...
         public virtual void SetOnShutdownCallback(HPSocketSdk.OnShutdown shutdown)
        {
            ...
            HPSocketSdk.HP_Set_FN_Server_OnShutdown(pListener, OnShutdownCallback);
        }
