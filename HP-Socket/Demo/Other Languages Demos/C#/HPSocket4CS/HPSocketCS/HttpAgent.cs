...
namespace HPSocketCS
{
    public class HttpAgent : TcpAgent
    {
        ...
        {
            return HttpSdk.HP_HttpAgent_SendRequest(pAgent, connId, method.ToString(), path, headers, headers.Length, body, body.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpAgent_SendLocalFile(pAgent, connId, fileName, method.ToString(), path, headers, headers.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpAgent_SendPost(pAgent, connId, path, headers, headers.Length, body, body.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpAgent_SendPut(pAgent, connId, path, headers, headers.Length, body, body.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpAgent_SendPatch(pAgent, connId, path, headers, headers.Length, body, body.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpAgent_SendGet(pAgent, connId, path, headers, headers.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpAgent_SendHead(pAgent, connId, path, headers, headers.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpAgent_SendTrace(pAgent, connId, path, headers, headers.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpAgent_SendOptions(pAgent, connId, path, headers, headers.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpAgent_SendConnect(pAgent, connId, path, headers, headers.Length);
        }
