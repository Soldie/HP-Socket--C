...
namespace HPSocketCS
{
    public class HttpClient : TcpClient
    {
        ...
        /// <returns></returns>
        public bool SendRequest(HttpMethod method, string path, THeader[] headers, string body)
        {
            return HttpSdk.HP_HttpClient_SendRequest(pClient, method.ToString(), path, headers, headers.Length, body, body.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpClient_SendLocalFile(pClient, fileName, method.ToString(), path, headers, headers.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpClient_SendPost(pClient, path, headers, headers.Length, body, body.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpClient_SendPut(pClient, path, headers, headers.Length, body, body.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpClient_SendPatch(pClient, path, headers, headers.Length, body, body.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpClient_SendGet(pClient, path, headers, headers.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpClient_SendDelete(pClient, path, headers, headers.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpClient_SendHead(pClient, path, headers, headers.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpClient_SendTrace(pClient, path, headers, headers.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpClient_SendOptions(pClient, path, headers, headers.Length);
        }
        ...
        {
            return HttpSdk.HP_HttpClient_SendConnect(pClient, path, headers, headers.Length);
        }
        ...
        /// <returns></returns>
        public bool AddCookie(string name, string value, bool relpace)
        {
            return HttpSdk.HP_HttpClient_AddCookie(pClient, name, value, relpace);
        }
        ...
        /// <param name="relpace">是否替换</param>
        /// <returns></returns>
        public bool AddCookie(TCookie cookie, bool relpace)
        {
            return HttpSdk.HP_HttpClient_AddCookie(pClient, cookie.Name, cookie.Value, relpace);
        }
        ...
        {
            return HttpSdk.HP_HttpClient_DeleteCookie(pClient, name);
        }
        ...
        {
            return HttpSdk.HP_HttpClient_DeleteAllCookies(pClient);
        }
