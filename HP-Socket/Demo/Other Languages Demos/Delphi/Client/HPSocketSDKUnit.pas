...
//* 获取监听 Socket 的地址信息 */
function HP_Server_GetListenAddress(pServer: HP_Server; lpszAddress: PChar; piAddressLen: Pointer; pusPort: Pointer):BOOL; stdcall; external HPSocketDLL;
//* 获取某个连接的本地地址信息 */
function HP_Server_GetLocalAddress(pServer: HP_Server; dwConnID: HP_CONNID; lpszAddress:array of PChar; piAddressLen: Pointer; pusPort: Pointer):BOOL; stdcall; external HPSocketDLL;
//* 获取某个连接的远程地址信息 */
function HP_Server_GetRemoteAddress(pServer: HP_Server; dwConnID: HP_CONNID; lpszAddress:array of PChar; piAddressLen: Pointer; pusPort: Pointer):BOOL; stdcall; external HPSocketDLL;
...
//* 获取某个连接的本地地址信息 */
function HP_Agent_GetLocalAddress(pAgent: HP_Agent; dwConnID: HP_CONNID; lpszAddress:array of PChar; piAddressLen: Pointer; pusPort: Pointer):BOOL; stdcall; external HPSocketDLL;
//* 获取某个连接的远程地址信息 */
function HP_Agent_GetRemoteAddress(pAgent: HP_Agent; dwConnID: HP_CONNID; lpszAddress:array of PChar; piAddressLen: Pointer; pusPort: Pointer):BOOL; stdcall; external HPSocketDLL;
//* 获取某个连接的远程主机信息 */
function HP_Agent_GetRemoteHost(pAgent: HP_Agent; dwConnID: HP_CONNID; lpszHost:array of PChar; piHostLen: Pointer; pusPort: Pointer):BOOL; stdcall; external HPSocketDLL;
//* 获取最近一次失败操作的错误代码 */
...
function HP_Client_GetLocalAddress(pClient: HP_Client; lpszAddress:array of PChar; piAddressLen: Pointer; pusPort: Pointer):BOOL; stdcall; external HPSocketDLL;
//* 获取连接的远程主机信息 */
function HP_Client_GetRemoteHost(pClient: HP_Client; lpszHost:array of PChar; piHostLen: Pointer; pusPort: Pointer):BOOL; stdcall; external HPSocketDLL;
//* 获取连接中未发出数据的长度 */
function HP_Client_GetPendingDataLength(pClient: HP_Client; piPending: Pointer):BOOL; stdcall; external HPSocketDLL;
...
// 获取 SOCKET 本地地址信息
function SYS_GetSocketLocalAddress(socket: SOCKET; lpszAddress:array of PChar; piAddressLen: Pointer; pusPort: Pointer):BOOL; stdcall; external HPSocketDLL;
// 获取 SOCKET 远程地址信息
function SYS_GetSocketRemoteAddress(socket: SOCKET; lpszAddress:array of PChar; piAddressLen: Pointer; pusPort: Pointer):BOOL; stdcall; external HPSocketDLL;

//* IPv4 字符串地址转换为整数 */
function SYS_GetIPv4InAddr(lpszAddress: PChar):Byte; stdcall; external HPSocketDLL;
//* 检查字符串是否符合 IP 地址格式 */
function SYS_IsIPAddress(lpszAddress: PChar):BOOL; stdcall; external HPSocketDLL;
//* 通过主机名获取 IP 地址 */
function SYS_GetIPAddress(lpszHost: PChar; lpszIP: Array of PChar; piIPLenth: Pointer):BOOL; stdcall; external HPSocketDLL;
//* 通过主机名获取最优的 IP 地址 */
function SYS_GetOptimalIPByHostName(lpszHost: PChar; pulAddr: Byte):BOOL; stdcall; external HPSocketDLL;
