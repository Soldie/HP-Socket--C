...
//* 通过主机名获取 IP 地址 */
function SYS_GetIPAddress(lpszHost: PChar; lpszIP: PChar;var piIPLenth: Integer):BOOL; stdcall; external HPSocketDLL;
//* 通过主机名获取最优的 IP 地址 */
function SYS_GetOptimalIPByHostName(lpszHost: PChar;var pulAddr: LongWord):BOOL; stdcall; external HPSocketDLL;
