...
En_HP_HandleResult CClientDlg::OnClose(HP_Client pClient, En_HP_SocketOperation enOperation, int iErrorCode)
{
	iErrorCode == HP_SE_OK ? ::PostOnClose(::HP_Client_GetConnectionID(pClient)):
