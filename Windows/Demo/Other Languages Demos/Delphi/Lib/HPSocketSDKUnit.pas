...
function HP_Server_Send(pServer: HP_Server; dwConnID: HP_CONNID; const pBuffer:
  PBYTE; iLength: Integer): BOOL; stdcall; external HPSocketDLL;
...
*			FALSE	-- 失败，可通过 SYS_GetLastError() 获取 Windows 错误代码
*/}
function HP_Server_SendPart(pServer: HP_Server; dwConnID: HP_CONNID; const pBuffer: PBYTE;
...
*			      FALSE	-- 失败
*/}
function HP_Server_DisconnectLongConnections(pServer: HP_Server; dwPeriod: DWORD;
...
function HP_Server_DisconnectSilenceConnections(pServer: HP_Server; dwPeriod:
  DWORD; bForce: BOOL): BOOL; stdcall; external HPSocketDLL;
...
function HP_Server_GetConnectionExtra(pServer: HP_Server; dwConnID: HP_CONNID;
  var ppExtra: PVOID): BOOL; stdcall; external HPSocketDLL;
...
function HP_Server_GetPendingDataLength(pServer: HP_Server; dwConnID: HP_CONNID;
  var piPending: Integer): BOOL; stdcall; external HPSocketDLL;
//* 获取连接的数据接收状态 */
...
function HP_Server_GetAllConnectionIDs(pServer: HP_Server; pIDs: HP_CONNIDArray;
  var pdwCount: DWord): BOOL; stdcall; external HPSocketDLL;
//* 获取某个客户端连接时长（毫秒） */
function HP_Server_GetConnectPeriod(pServer: HP_Server; dwConnID: HP_CONNID;
  var pdwPeriod: DWord): BOOL; stdcall; external HPSocketDLL;
//* 获取某个连接静默时间（毫秒） */
function HP_Server_GetSilencePeriod(pServer: HP_Server; dwConnID: HP_CONNID;
  var pdwPeriod: DWord): BOOL; stdcall; external HPSocketDLL;
//* 获取监听 Socket 的地址信息 */
function HP_Server_GetListenAddress(pServer: HP_Server; lpszAddress: PChar; var
...
function HP_Server_GetLocalAddress(pServer: HP_Server; dwConnID: HP_CONNID;
  lpszAddress: PChar; var piAddressLen: Integer; var pusPort: Word): BOOL; stdcall; external HPSocketDLL;
//* 获取某个连接的远程地址信息 */
...
procedure HP_Server_SetMaxConnectionCount(pServer: HP_Server;
  dwMaxConnectionCount: DWord); stdcall; external HPSocketDLL;
...
function HP_TcpServer_SendSmallFile(pServer: HP_Server; dwConnID: HP_CONNID;
  lpszFileName: PChar; const pHead: LPWSABUF; const pTail: LPWSABUF): BOOL; stdcall; external HPSocketDLL;
...
*			FALSE	-- 失败，可通过函数 SYS_GetLastError() 获取 Windows 错误代码
*/}
function HP_Agent_ConnectWithExtra(pAgent: HP_Agent; lpszRemoteAddress: PChar; usPort: USHORT; pdwConnID: PInteger; pExtra: PVOID): BOOL; stdcall; external HPSocketDLL;
...
//* 获取连接数 */
function HP_Agent_GetConnectionCount(pAgent: HP_Agent): DWord; stdcall; external
  HPSocketDLL;
//* 获取所有连接的 HP_CONNID */
...
function HP_Agent_GetLocalAddress(pAgent: HP_Agent; dwConnID: HP_CONNID;
  lpszAddress: PChar; var piAddressLen: Integer; var pusPort: USHORT): BOOL; stdcall; external HPSocketDLL;
//* 获取某个连接的远程地址信息 */
...
function HP_Agent_GetRemoteHost(pAgent: HP_Agent; dwConnID: HP_CONNID; lpszHost:
  PChar; var piHostLen: Integer; var Integer: USHORT): BOOL; stdcall; external HPSocketDLL;
//* 获取最近一次失败操作的错误代码 */
...
function HP_Client_StartWithBindAddress(pClient: HP_Client; lpszRemoteAddress:
  PChar; usPort: USHORT; bAsyncConnect: BOOL; lpszBindAddress: PChar): BOOL; stdcall; external HPSocketDLL;
...
*			FALSE	-- 失败，可通过 SYS_GetLastError() 获取 Windows 错误代码
*/ }
function HP_Client_SendPart(pClient: HP_Client; const pBuffer: PByte; iLength:
...
*			FALSE	-- 失败，可通过 SYS_GetLastError() 获取 Windows 错误代码
*/}
function HP_TcpClient_SendSmallFile(pClient: HP_Client; lpszFileName: PChar;
...
procedure HP_TcpClient_SetSocketBufferSize(pClient: HP_TcpClient;
  dwSocketBufferSize: DWord); stdcall; external HPSocketDLL;
//* 设置正常心跳包间隔（毫秒，0 则不发送心跳包，默认：30 * 1000） */
...
procedure HP_TcpClient_SetKeepAliveInterval(pClient: HP_TcpClient;
  dwKeepAliveInterval: DWord); stdcall; external HPSocketDLL;
...
function HP_TcpPullServer_Fetch(pServer: HP_TcpPullServer; dwConnID: HP_CONNID;
  pData: PByte; iLength: Integer): En_HP_FetchResult; stdcall; external HPSocketDLL;
...
* 返回值：	En_HP_FetchResult
*/}
function HP_TcpPullClient_Fetch(pClient: HP_TcpPullClient; pData: PByte;
...
* 返回值：	En_HP_FetchResult
*/}
function HP_TcpPullClient_Peek(pClient: HP_TcpPullClient; pData: PByte;
  iLength: Integer): En_HP_FetchResult; stdcall; external HPSocketDLL;
...
// 调用系统的 WSAIoctl()
function SYS_WSAIoctl(sock: SOCKET; dwIoControlCode: DWord; lpvInBuffer: Pointer;
  cbInBuffer: DWord; lpvOutBuffer: Pointer; cbOutBuffer: DWord; lpcbBytesReturned: LPDWORD): Integer; stdcall; external HPSocketDLL;
...
function SYS_CompressEx(const lpszSrc: PChar; dwSrcLen: LongWord;var lpszDest:
  PChar;var pdwDestLen: LongWord; iLevel: Integer; iMethod: Integer; iWindowBits:
  Integer; iMemLevel: Integer; iStrategy: Integer): Integer; stdcall; external HPSocketDLL;
// 普通解压
...
function SYS_UncompressEx(const lpszSrc: PChar; dwSrcLen: LongWord;var lpszDest:
  PChar;var pdwDestLen: LongWord; iWindowBits: Integer): Integer; stdcall; external HPSocketDLL;
// 推测压缩结果长度
function SYS_GuessCompressBound(dwSrcLen: LongWord; bGZip: BOOL): LongWord; stdcall; external HPSocketDLL;

// Gzip 压缩
function SYS_GZipCompress(const lpszSrc: PChar; dwSrcLen: LongWord;var lpszDest:
  PChar;var pdwDestLen: LongWord): Integer; stdcall; external HPSocketDLL;
// Gzip 解压
function SYS_GZipUncompress(const lpszSrc: PChar; dwSrcLen: LongWord;var lpszDest:
  PChar;var pdwDestLen: LongWord): Integer; stdcall; external HPSocketDLL;
...
type
  ...
  HP_FN_Http_OnWSMessageHeader = function(pSender: HP_Http; dwConnID: HP_CONNID; bFinal: BOOL; iReserved: byte; iOperationCode: byte; const lpszMask: array of byte;
...
function HP_HttpServer_SendResponse(pServer: HP_HttpServer; dwConnID: HP_CONNID;
  usStatusCode: USHORT; lpszDesc: PChar; const lpHeaders: HP_THeaderAry; iHeaderCount:
  Integer; const pData: PByte; iLength: Integer): BOOL; stdcall; external HPSocketDLL;
...
function HP_HttpServer_SendLocalFile(pServer: HP_HttpServer; dwConnID: HP_CONNID;
  lpszFileName: PChar; usStatusCode: USHORT; lpszDesc: PChar; const lpHeaders:
  HP_THeaderAry; iHeaderCount: Integer): BOOL; stdcall; external HPSocketDLL;
{/*
* 名称：发送 WebSocket 消息
...
function HP_HttpServer_SendWSMessage(pServer: HP_HttpServer; dwConnID: HP_CONNID;
  bFinal: BOOL; iReserved: byte; iOperationCode: byte; const lpszMask: array of Byte;
  pData: pbyte; iLength: Integer; ullBodyLen: LongWord): BOOL; stdcall; external
  HPSocketDLL;
...
function HP_HttpServer_GetWSMessageState(pServer: HP_HttpServer; dwConnID: HP_CONNID;
  var lpbFinal: BOOL;var lpiReserved: byte;var lpiOperationCode: byte;var lpszMask: PByte;
  var lpullBodyLen: LongWord;var lpullBodyRemain: LongWord): BOOL; stdcall; external HPSocketDLL;
...
function HP_HttpAgent_SendRequest(pAgent: HP_HttpAgent; dwConnID: HP_CONNID;
  lpszMethod: PChar; lpszPath: PChar; const lpHeaders: HP_THeaderAry; iHeaderCount:
  Integer; const pData: PByte; iLength: Integer): BOOL; stdcall; external HPSocketDLL;
...
function HP_HttpAgent_SendLocalFile(pAgent: HP_HttpAgent; dwConnID: HP_CONNID;
  lpszFileName: PChar; lpszMethod: PChar; lpszPath: PChar; const lpHeaders:
  HP_THeaderAry; iHeaderCount: Integer): BOOL; stdcall; external HPSocketDLL;

//* 发送 POST 请求 */
function HP_HttpAgent_SendPost(pAgent: HP_HttpAgent; dwConnID: HP_CONNID;
  lpszPath: PChar; const lpHeaders: HP_THeaderAry; iHeaderCount: Integer;
  const pBody:PByte; iLength: Integer): BOOL; stdcall; external HPSocketDLL;
//* 发送 PUT 请求 */
function HP_HttpAgent_SendPut(pAgent: HP_HttpAgent; dwConnID: HP_CONNID;
  lpszPath: PChar; const lpHeaders: HP_THeaderAry; iHeaderCount: Integer; const pBody:
  PByte; iLength: Integer): BOOL; stdcall; external HPSocketDLL;
//* 发送 PATCH 请求 */
...
function HP_HttpAgent_SendGet(pAgent: HP_HttpAgent; dwConnID: HP_CONNID;
  lpszPath: PChar; const lpHeaders: HP_THeaderAry; iHeaderCount: Integer): BOOL; stdcall; external HPSocketDLL;
//* 发送 DELETE 请求 */
...
function HP_HttpAgent_SendConnect(pAgent: HP_HttpAgent; dwConnID: HP_CONNID;
  lpszHost: PChar; const lpHeaders: HP_THeaderAry; iHeaderCount: Integer): BOOL; stdcall; external HPSocketDLL;
{/*
* 名称：发送 WebSocket 消息
* 描述：向对端端发送 WebSocket 消息
*
...
function HP_HttpAgent_GetWSMessageState(pAgent: HP_HttpAgent; dwConnID: HP_CONNID;
  var lpbFinal: BOOL;var lpiReserved: Byte;var lpiOperationCode: Byte;
  var lpszMask: PByte;var lpullBodyLen: LongWord;var lpullBodyRemain: LongWord): BOOL; stdcall; external HPSocketDLL;
...
*			FALSE			-- 失败
*/}
function HP_HttpClient_SendRequest(pClient: HP_HttpClient; lpszMethod: PChar;
  lpszPath: PChar; const lpHeaders: HP_THeaderAry; iHeaderCount: Integer;
  const pBody:PByte; iLength: Integer): BOOL; stdcall; external HPSocketDLL;
...
*			FALSE			-- 失败
*/}
function HP_HttpClient_SendLocalFile(pClient: HP_HttpClient; lpszFileName: PChar;
  lpszMethod: PChar; lpszPath: PChar; const lpHeaders: HP_THeaderAry; iHeaderCount:
  Integer): BOOL; stdcall; external HPSocketDLL;

//* 发送 POST 请求 */
function HP_HttpClient_SendPost(pClient: HP_HttpClient; lpszPath: PChar; const
  lpHeaders: HP_THeaderAry; iHeaderCount: Integer; const pBody: PByte; iLength:Integer): BOOL; stdcall; external HPSocketDLL;
//* 发送 PUT 请求 */
function HP_HttpClient_SendPut(pClient: HP_HttpClient; lpszPath: PChar; const
  lpHeaders: HP_THeaderAry; iHeaderCount: Integer; const pBody: PByte; iLength: Integer): BOOL; stdcall; external HPSocketDLL;
//* 发送 PATCH 请求 */
function HP_HttpClient_SendPatch(pClient: HP_HttpClient; lpszPath: PChar; const
  lpHeaders: HP_THeaderAry; iHeaderCount: Integer; const pBody: PByte; iLength: Integer): BOOL; stdcall; external HPSocketDLL;
//* 发送 GET 请求 */
function HP_HttpClient_SendGet(pClient: HP_HttpClient; lpszPath: PChar; const
  lpHeaders: TNVPair; iHeaderCount: Integer): BOOL; stdcall; external HPSocketDLL;
//* 发送 DELETE 请求 */
function HP_HttpClient_SendDelete(pClient: HP_HttpClient; lpszPath: PChar; const
  lpHeaders: HP_THeaderAry; iHeaderCount: Integer): BOOL; stdcall; external HPSocketDLL;
//* 发送 HEAD 请求 */
function HP_HttpClient_SendHead(pClient: HP_HttpClient; lpszPath: PChar; const
  lpHeaders: HP_THeaderAry; iHeaderCount: Integer): BOOL; stdcall; external HPSocketDLL;
//* 发送 TRACE 请求 */
function HP_HttpClient_SendTrace(pClient: HP_HttpClient; lpszPath: PChar; const
  lpHeaders: HP_THeaderAry; iHeaderCount: Integer): BOOL; stdcall; external HPSocketDLL;
//* 发送 OPTIONS 请求 */
function HP_HttpClient_SendOptions(pClient: HP_HttpClient; lpszPath: PChar;
  const lpHeaders: HP_THeaderAry; iHeaderCount: Integer): BOOL; stdcall; external HPSocketDLL;
//* 发送 CONNECT 请求 */
function HP_HttpClient_SendConnect(pClient: HP_HttpClient; lpszHost: PChar;
  const lpHeaders: HP_THeaderAry; iHeaderCount: Integer): BOOL; stdcall; external HPSocketDLL;
{/*
* 名称：发送 WebSocket 消息
* 描述：向对端端发送 WebSocket 消息
...
function HP_HttpClient_SendWSMessage(pClient: HP_HttpClient; bFinal: BOOL;
  iReserved: Byte; iOperationCode: Byte; const lpszMask: Array of Byte; pData: PByte;
...
//* 获取当前 WebSocket 消息状态，传入 nullptr 则不获取相应字段 */
function HP_HttpClient_GetWSMessageState(pClient: HP_HttpClient;var lpbFinal: BOOL;
  var lpiReserved: Byte;var lpiOperationCode: byte;var lpszMask: pbyte;
  var lpullBodyLen: LongWord;var lpullBodyRemain: LongWord): BOOL; stdcall; external HPSocketDLL;
...
*			FALSE			-- 失败
*/}
function HP_HttpSyncClient_OpenUrl(pClient: HP_HttpSyncClient; lpszMethod: PChar;
  lpszUrl: PChar; const lpHeaders: HP_THeaderAry; iHeaderCount: Integer; const pBody:
  PByte; iLength: Integer; bForceReconnect: BOOL): BOOL; stdcall; external HPSocketDLL;
{/*
* 名称：清除请求结果
...
//* 设置 Cookie */
function HP_HttpCookie_MGR_SetCookie(lpszName: PChar; lpszValue: PChar;
  lpszDomain: PChar; lpszPath: PChar; iMaxAge: Integer = -1;
  bHttpOnly: BOOL = False; bSecure: BOOL = False; enSameSite: Integer = 0;
  bOnlyUpdateValueIfExists: BOOL = True): BOOL; stdcall; external HPSocketDLL;
//* 删除 Cookie */
...
//* 生成 Cookie 字符串 */
function HP_HttpCookie_HLP_ToString(lpszBuff: array of Char;var piBuffLen: Integer;
  lpszName: PChar; lpszValue: PChar; lpszDomain: PChar; lpszPath: PChar;
  iMaxAge: Integer = -1; bHttpOnly: BOOL =False; bSecure: BOOL = False; enSameSite: Integer = 0): BOOL; stdcall; external HPSocketDLL;
...
*/}
function Create_HP_SocketTaskObj(fnTaskProc: Fn_SocketTaskProc ; pSender: PVOID; dwConnID: HP_CONNID;
   pBuffer: PBYTE ;iBuffLen: Integer; enBuffType: En_HP_TaskBufferType=TBT_COPY; wParam: WPARAM= 0;lParam: LPARAM=0):HP_LPTSocketTask; stdcall; external HPSocketDLL;
...
*/}
function HP_ThreadPool_Start(pThreadPool: HP_ThreadPool;dwThreadCount: DWORD= 0; dwMaxQueueSize: DWORD = 0;
   enRejectedPolicy: En_HP_RejectedPolicy= TRP_CALL_FAIL;dwStackSize: DWORD= 0): BOOL; stdcall; external HPSocketDLL;
